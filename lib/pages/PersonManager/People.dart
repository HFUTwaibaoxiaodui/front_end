...
//        if (_listDatas[i].indexLetter == _listDatas[i - 1].indexLetter) {
  ...
  final List<Heads> _headerData = [
    Heads(imageUrl: 'assets/images/新的朋友.png', name: '选择人员'),
...
//    系统cell
    ...
    bool _hideIndexLetter = (index - 3 > 0 &&
        _listDatas[index - 3].indexLetter == _listDatas[index - 4].indexLetter);
    return _FriendsCell(
      imageUrl: _listDatas[index - 3].imageUrl!,
      name: _listDatas[index - 3].name!,
      groupTitle: _hideIndexLetter ? null : _listDatas[index - 3].indexLetter!,
    );
  }
        ...
        Material(
          ...
          child: InkWell(
            ...
            onTap: (){
              print('点击了');
              Navigator.of(context).push(
                  CupertinoPageRoute(builder: (BuildContext context){return SelectPeoplesPage();})
              );
            },
            child: Row(
              children: <Widget>[
...
class _HeadCellone extends StatelessWidget {
  final String? imageUrl;
  final String name;
  final String? groupTitle;
  final String? imageAssets;

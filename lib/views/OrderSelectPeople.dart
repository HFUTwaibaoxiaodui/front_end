...
import '../pages/PersonManager/IndexBar.dart';
import '../pages/PersonManager/SearchPage.dart';
import '../pages/PersonManager/friends_data.dart';


class OrderSelectPeoplePage extends StatefulWidget {


  const OrderSelectPeoplePage({Key? key}) : super(key: key);

  _OrderSelectPeoplePageState createState() => _OrderSelectPeoplePageState();
}

Dio dio =Dio();
class _OrderSelectPeoplePageState extends State<OrderSelectPeoplePage> {
//  字典里面放item和高度的对应数据

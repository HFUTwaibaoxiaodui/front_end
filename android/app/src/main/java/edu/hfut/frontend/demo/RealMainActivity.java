package edu.hfut.frontend.demo;
...
import edu.hfut.frontend.demo.basic.Animate_CameraActivity;
import edu.hfut.frontend.demo.basic.BasicMapActivity;
import edu.hfut.frontend.demo.basic.CameraActivity;
import edu.hfut.frontend.demo.basic.EventsActivity;
import edu.hfut.frontend.demo.basic.GestureSettingsActivity;
import edu.hfut.frontend.demo.basic.HeatMapActivity;
import edu.hfut.frontend.demo.basic.LayersActivity;
import edu.hfut.frontend.demo.basic.LimitBoundsActivity;
import edu.hfut.frontend.demo.basic.LogoSettingsActivity;
import edu.hfut.frontend.demo.basic.MinMaxZoomLevelActivity;
import edu.hfut.frontend.demo.overlay.ParticleMapActivity;
import edu.hfut.frontend.demo.overlay.ParticleWeatherMapActivity;
import edu.hfut.frontend.demo.basic.PoiClickActivity;
import edu.hfut.frontend.demo.basic.ScreenShotActivity;
import edu.hfut.frontend.demo.basic.TwoMapActivity;
import edu.hfut.frontend.demo.basic.UiSettingsActivity;
import edu.hfut.frontend.demo.basic.ViewPagerWithMapActivity;
import edu.hfut.frontend.demo.basic.ZoomActivity;
import edu.hfut.frontend.demo.basic.map.MapImpMethodActivity;
import edu.hfut.frontend.demo.busline.BusStationActivity;
import edu.hfut.frontend.demo.busline.BuslineActivity;
import edu.hfut.frontend.demo.cloud.CloudActivity;
import edu.hfut.frontend.demo.district.DistrictActivity;
import edu.hfut.frontend.demo.district.DistrictWithBoundaryActivity;
import edu.hfut.frontend.demo.geocoder.GeocoderActivity;
import edu.hfut.frontend.demo.geocoder.ReGeocoderActivity;
import edu.hfut.frontend.demo.indoor.IndoorMapActivity;
import edu.hfut.frontend.demo.inputtip.InputtipsActivity;
import edu.hfut.frontend.demo.listmap.MapListViewActivity;
import edu.hfut.frontend.demo.listmap.RecycleViewActivity;
import edu.hfut.frontend.demo.location.CustomLocationActivity;
import edu.hfut.frontend.demo.location.CustomLocationModeActivity;
import edu.hfut.frontend.demo.location.LocationModeSourceActivity;
import edu.hfut.frontend.demo.location.LocationModeSourceActivity_Old;
import edu.hfut.frontend.demo.offlinemap.OfflineMapActivity_Old;
import edu.hfut.frontend.demo.opengl.OpenglActivity;
import edu.hfut.frontend.demo.overlay.ArcActivity;
import edu.hfut.frontend.demo.overlay.BuildingOverlayActivity;
import edu.hfut.frontend.demo.overlay.CircleActivity;
import edu.hfut.frontend.demo.overlay.ColourfulPolylineActivity;
import edu.hfut.frontend.demo.overlay.CustomMarkerActivity;
import edu.hfut.frontend.demo.overlay.GeodesicActivity;
import edu.hfut.frontend.demo.overlay.GroundOverlayActivity;
import edu.hfut.frontend.demo.overlay.HoleActivity;
import edu.hfut.frontend.demo.overlay.InfoWindowActivity;
import edu.hfut.frontend.demo.overlay.MarkerActivity;
import edu.hfut.frontend.demo.overlay.MarkerAnimationActivity;
import edu.hfut.frontend.demo.overlay.MarkerClickActivity;
import edu.hfut.frontend.demo.overlay.MultiPointOverlayActivity;
import edu.hfut.frontend.demo.overlay.NavigateArrowOverlayActivity;
import edu.hfut.frontend.demo.overlay.PolygonActivity;
import edu.hfut.frontend.demo.overlay.PolylineActivity;
import edu.hfut.frontend.demo.overlay.ProvinceHoleActivity;
import edu.hfut.frontend.demo.poisearch.PoiAroundSearchActivity;
import edu.hfut.frontend.demo.poisearch.PoiIDSearchActivity;
import edu.hfut.frontend.demo.poisearch.PoiKeywordSearchActivity;
import edu.hfut.frontend.demo.poisearch.SubPoiSearchActivity;
import edu.hfut.frontend.demo.route.BusRouteActivity;
import edu.hfut.frontend.demo.route.DriveRouteActivity;
import edu.hfut.frontend.demo.route.DriveRoutePlanActivity;
import edu.hfut.frontend.demo.route.RideRouteActivity;
import edu.hfut.frontend.demo.route.RouteActivity;
import edu.hfut.frontend.demo.route.RouteDistanceActivity;
import edu.hfut.frontend.demo.route.TruckRouteActivity;
import edu.hfut.frontend.demo.route.WalkRouteActivity;
import edu.hfut.frontend.demo.routepoi.RoutePOIActivity;
import edu.hfut.frontend.demo.share.ShareActivity;
import edu.hfut.frontend.demo.smooth.SmoothMoveActivity;
import edu.hfut.frontend.demo.tools.CalculateDistanceActivity;
import edu.hfut.frontend.demo.tools.ContainsActivity;
import edu.hfut.frontend.demo.tools.CoordConverActivity;
import edu.hfut.frontend.demo.tools.GeoToScreenActivity;
import edu.hfut.frontend.demo.trace.TraceActivity;
import edu.hfut.frontend.demo.trace.TraceActivity_Simple;
import edu.hfut.frontend.demo.view.FeatureView;
import edu.hfut.frontend.demo.weather.WeatherSearchActivity;

import java.lang.reflect.Method;
import java.util.ArrayList;
import java.util.List;
import edu.hfut.frontend.R;
import edu.hfut.frontend.demo.overlay.HoneycombHeatMapActivity;


/**
 * AMapV2地图demo总汇
 */
public final class RealMainActivity extends ListActivity {
...
//			平滑移动
	...
	private void privacyCompliance() {
		MapsInitializer.updatePrivacyShow(RealMainActivity.this,true,true);
		...
		new AlertDialog.Builder(this)
				...
				.setPositiveButton("同意", new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialogInterface, int i) {
						MapsInitializer.updatePrivacyAgree(RealMainActivity.this,true);
					}
				})
				.setNegativeButton("不同意", new DialogInterface.OnClickListener() {
					@Override
					public void onClick(DialogInterface dialogInterface, int i) {
						MapsInitializer.updatePrivacyAgree(RealMainActivity.this,false);
					}
				})
				.show();
	}
